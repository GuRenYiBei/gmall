...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCategoryId(@PathVariable Long categoryId,PageParamVo pageParamVo) {
        PageResultVo pageResultVo = this.spuService.querySpuByCategoryId(categoryId, pageParamVo);
